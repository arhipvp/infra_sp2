# Generated by Django 3.2 on 2023-02-05 15:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[reviews.validators.year_validator], verbose_name='Гоп производства')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(validators=[django.core.validators.MinValueValidator(1, 'Не может быть меньше 1'), django.core.validators.MaxValueValidator(10, 'Не может быть больше 10')], verbose_name='Рейтинг')),
                ...
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='reviews.title', verbose_name='review title')),
            ],
            options={
                'verbose_name': 'Отзыв',
